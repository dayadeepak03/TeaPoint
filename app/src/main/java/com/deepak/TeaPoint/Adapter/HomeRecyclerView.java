...
public class HomeRecyclerView extends RecyclerView.Adapter<HomeRecyclerView.viewHolder> {
    ...
    public HomeRecyclerView(Context mContext, List<Hero> heroList) {
        this.mContext = mContext;
        this.heroList = heroList;
    }

    @Override
    public HomeRecyclerView.viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_card,parent,false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(final HomeRecyclerView.viewHolder holder, final int position) {
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pos != RecyclerView.NO_POSITION){
                    ...
                    intent.putExtra("thumbnail", heroList.get(pos).getImageurl());
